...
class InstanceScreen : Fragment(), InstanceScreenType.ScreenAll {
    ...
    companion object {
        fun newInstance(context: Context, projectScreen: ProjectScreen): InstanceScreen {
            val fragment = InstanceScreen()
    ...
    private var screenType: InstanceScreenType? = null
    private var screenStyle: InstanceScreenStyle? = null
    ...
    private suspend fun getTypeList() {
        try {
            ...
            if (it.code() in 200..299) {
                ...
                screenType = InstanceScreenType.newInstance(this@InstanceScreen, typeList)
