...
class ProjectSideListScreen : Fragment(), ProjectSideScreenType.ScreenAll, ProjectSideScreenStyle.ScreenAll {
    ...
    companion object {
        fun newInstance(context: Context, projectScreen: ProjectScreen): ProjectSideListScreen {
            val fragment = ProjectSideListScreen()
    ...
    private var screenType: ProjectSideScreenType? = null
    private var screenStyle: ProjectSideScreenStyle? = null
    ...
    private fun createV(): View {
        ...
        screenType = ProjectSideScreenType.newInstance(this@ProjectSideListScreen)
        screenStyle = ProjectSideScreenStyle.newInstance(this@ProjectSideListScreen,mutableListOf())
        return UI {
            linearLayout {
    ...
    private suspend fun getTypeList() {
        try {
            ...
            if (it.code() in 200..299) {
                ...
                screenType = ProjectSideScreenType.newInstance(this@ProjectSideListScreen, typeList)
